...
export default function HospitalPage() {
  ...
  useEffect(() => {
    setIsClient(true); // Ensure animations run only on the client
  }, []);
          ...
          >
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
              <div className="relative">
                ...
                <Input placeholder="Search hospitals..." className="pl-10 h-12 rounded-xl border-sky-100 focus:border-sky-500" />
              </div>
            </motion.div>
          </motion.header>
        )}
